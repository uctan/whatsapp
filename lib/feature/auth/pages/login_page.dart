...
import 'package:tanapp/common/helper/show_alert_dialog.dart';
...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  sendCodeToPhone() {
    ...
    if (phoneNumber.isEmpty) {
      ...
      return showAlertDialog(
          context: context,
          message:
              "The phone number you enterd is too short for the country: $countryName. \n\n Include your are code if you haven't");
    } else if (phoneNumber.length > 10) {
      return showAlertDialog(
        context: context,
        message:
            'The phone number you enterd is too long for the country: $countryName',
      );
    }
  ...
  @override
  void initState() {
    countryNameController = TextEditingController(text: 'Viet Nam');
